<?php
  ...
  $alumno = new tutoria;
  $consulta = "SELECT a.nombre as nombreAlumno, a.NumControl as NumControl, m.nombre as NombreMateria, k.idkardex, k.parcial1, k.parcial2, k.parcial3, k.parcial4, k.obser1, k.obser2, k.obser3, k.obser4, k.obser1t,k.obser2t,k.obser3t,k.obser4t from kardex as k
            ...
            <table class="table table-bordered" id="" width="100%" cellspacing="0">
              ...
              <tbody>
                <tr>
                  ...
                  <td><label for=""><?php echo $array[0]['obser1'] ?></label></td>
                  <td class="form-inline"><input type="text" class="form-control" style="width:90%;" placeholder="Insertar Observación" value="<?php echo $array[0]['obser1t'] ?>" id="obser1t"> <a onclick="guardaObsT('obser1t','<?php echo $array[0]['idkardex']?>')"><i class="far fa-save" style="font-size:35px;color:gray;"></i></a></td>
                </tr>
                <tr>
                  <td>2</td>
                  <td><?php echo $array[0]['parcial2'] ?></td>
                  <td><label for=""><?php echo $array[0]['obser2'] ?></label></td>
                  <td class="form-inline"><input type="text" class="form-control" style="width:90%;" placeholder="Insertar Observación" value="<?php echo $array[0]['obser2t'] ?>" id="obser2t"> <a onclick="guardaObsT('obser2t','<?php echo $array[0]['idkardex']?>')"><i class="far fa-save" style="font-size:35px;color:gray;"></i></a></td>
                </tr>
                <tr>
                  <td>3</td>
                  <td><?php echo $array[0]['parcial3'] ?></td>
                  <td><label for=""><?php echo $array[0]['obser3'] ?></label></td>
                  <td class="form-inline"><input type="text" class="form-control" style="width:90%;" placeholder="Insertar Observación" value="<?php echo $array[0]['obser3t'] ?>" id="obser3t"><a onclick="guardaObsT('obser3t','<?php echo $array[0]['idkardex']?>')"> <i class="far fa-save" style="font-size:35px;color:gray;"></i></a></td>
                </tr>
                <tr>
                  <td>4</td>
                  <td><?php echo $array[0]['parcial4'] ?></td>
                  <td><label for=""><?php echo $array[0]['obser4'] ?></label></td>
                  <td class="form-inline"><input type="text" class="form-control" style="width:90%;" placeholder="Insertar Observación" value="<?php echo $array[0]['obser4t'] ?>" id="obser4t"> <a onclick="guardaObsT('obser4t','<?php echo $array[0]['idkardex']?>')"><i class="far fa-save" style="font-size:35px;color:gray;"></i></a></td>
                </tr>
              </tbody>
            </table>
</div>
