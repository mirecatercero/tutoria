...
<div class="col-md-8" style="background-color:#428bca; margin:30px auto;"><h2 class="titulo1"><i class="fas fa-user" style="color:white; font-size:22px;"></i> Elda Ramírez González</h2></div>
<div class="col-md-8 form-inline" style="margin: 15px auto;">
<select name="materiaProfesor" class="form-control" style="width:40%;" id="selectMateria" onchange = "filtrarMateriaMT()">
